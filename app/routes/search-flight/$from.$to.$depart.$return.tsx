...
export default function Search() {
  const { flightSearch, apiUrl } = useLoaderData<typeof loader>();
      ...
      <div className='bg-white dark:bg-gray-900'>
        <div className='md:flex justify-between mx-4 max-w-screen-xl bg-white dark:bg-gray-900 xl:p-9 xl:mx-auto'>
          ...
          <div className='w-full md:ml-2'>
            {error !== '' ? <div className='dark:text-white'> {error}
            </div> : <>
              ...
              <FlightResultsDefault flights={'error' in search ? undefined : search} filters={filters} />
            </>}
          </div>
        </div>
      </div>
