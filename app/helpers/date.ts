...
export const getSEODateDetails = (results: IndicitiveResults, quoteKey: string) => {
    const quote = results.quotes[quoteKey];
    const placeInboundOrigin = results.places[quote.inboundLeg.originPlaceId];
    const placeInboundDestination = results.places[quote.inboundLeg.destinationPlaceId];
    const placeOutboundOrigin = results.places[quote.outboundLeg.originPlaceId];
    const placeOutboundDestination = results.places[quote.outboundLeg.destinationPlaceId];
