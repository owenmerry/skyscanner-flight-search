...
export const Button = ({ text, link, onClick, secondary, isFull = false }: ButtonProps) => {
  return (
    <a
      className={`${isFull ? `w-full` : ''} cursor-pointer lg:col-span-2 justify-center md:w-auto text-white ${
        secondary
