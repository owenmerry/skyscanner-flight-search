      ...
      {!search ? '' : (<>
        {sortByPrice(search.content.groupingOptions.byRoute.quotesGroups).map((quoteKey) => {
          ...
          return (<div className='panel'>
            ...
            <div><Link className='button' to={`/search/${placeOutboundOrigin?.iata}/${placeOutboundDestination?.iata}/${convertDateToYYYMMDDFormat(dateOutboundFlight)}/${convertDateToYYYMMDDFormat(dateInboundFlight)}`}>Search Deal</Link></div>
          </div>);
