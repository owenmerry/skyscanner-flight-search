...
export const Article = ({
    ...
    return (<article className="p-4 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        {image ? <Link to={to}>
            <img
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                    ...
                    <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
                        Use are different search features to make a perfect search for your next holiday plans.
                    </p>
                </div>
