...
export const HeaderDefault = ({
    ...
    const menuItems = [
        ...
        { title: 'Explore', to: '/seo', selected: selectedUrl === '/seo' },
        { title: 'Flights', to: '/search-flight', selected: selectedUrl === '/search-flight' },
        { title: 'Hotels', to: '/search', selected: selectedUrl === '/search' },
        { title: 'Cars', to: '/search', selected: selectedUrl === '/search' },
    ]
    ...
    return (<header>
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div
                    className={`${showMobileMenu ? `` : `hidden`} justify-between items-center w-full lg:flex lg:w-auto lg:order-1`}
                >
